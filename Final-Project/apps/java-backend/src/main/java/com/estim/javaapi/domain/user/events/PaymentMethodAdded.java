...
/**
 * Domain event raised when a new payment method is added to a user.
 */
public final class PaymentMethodAdded implements DomainEvent {

    private final UserId userId;
    private final PaymentMethodId paymentMethodId;
    private final Instant occurredAt;

    public PaymentMethodAdded(UserId userId, PaymentMethodId paymentMethodId, Instant occurredAt) {
        this.userId = userId;
